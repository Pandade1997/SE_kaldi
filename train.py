...
parser.add_argument('--ck_name', default='se_kaldi.pt')
parser.add_argument('--out_train_path', default='/data01/AuFast/Pan_dataset/SE_asr/kaldi/out_train/')
parser.add_argument('--out_dev_path', default='/data01/AuFast/Pan_dataset/SE_asr/kaldi/out_dev/')
